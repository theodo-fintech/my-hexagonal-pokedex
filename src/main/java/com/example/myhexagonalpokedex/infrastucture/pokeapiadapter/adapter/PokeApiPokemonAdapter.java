...
import com.example.myhexagonalpokedex.infrastucture.pokeapiadapter.mapper.PokemonDetailsMapper;
...
public class PokeApiPokemonAdapter implements PokemonApiFetcher {
    ...
    public Pokemon findById(Integer pokemonId) {
        final PokemonDetailsDTO pokemonDetailsDTO = pokeApiHttpClient.findById(pokemonId);
        return PokemonDetailsMapper.fromDtoToDomain(pokemonDetailsDTO);
    }
}
